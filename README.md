...
| [`git-hygiene`](plugins/git-hygiene) | Separates branches proved safe to delete from those not proved safe, and manages linked worktrees through hidden placement, deterministic checks, and exact-path approvals. |
