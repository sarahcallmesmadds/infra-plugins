...
allowed-tools: Read, Bash(git branch --show-current:*), Bash(git rev-parse:*), Bash(git symbolic-ref:*), Bash(git rev-list:*), Bash(git log:*), Bash(git status:*), Bash(gh pr view:*)
---
