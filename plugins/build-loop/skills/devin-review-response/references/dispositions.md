...
| `out-of-scope` | The issue predates the PR or belongs to unrelated work. | Nonblank base-branch or blame evidence proving it predates the reviewed change. Use `null` for `tracking_id`; a finding that needs tracked follow-up is `deferred`. |
